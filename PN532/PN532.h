...
#define PN532_FELICA_212                    (0x01)   // as explained in datasheet p119
...
public:
    ...
    */
    ...
    uint32_t readPassiveTargetID(uint8_t cardtype, uint16_t timeout = 1000);
    bool inAutoPoll(uint16_t timeout = 1000);  // TT added
    bool readFeliCa(uint16_t timeout = 1000);  // TT added
